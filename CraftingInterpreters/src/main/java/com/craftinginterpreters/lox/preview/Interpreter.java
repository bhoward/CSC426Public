...
import com.craftinginterpreters.lox.ch10.Return;
import com.craftinginterpreters.lox.ch11.Environment;
...
public class Interpreter {
    ...
    private Object evaluate(Expr expr) {
        ...
        case Expr.Grouping e -> {
            return visitGroupingExpr(e);
        }
        case Expr.Literal e -> {
            return visitLiteralExpr(e);
        }
        case Expr.Logical e -> {
            return visitLogicalExpr(e);
        }
        case Expr.Set e -> {
            return visitSetExpr(e);
        }
        case Expr.Super e -> {
    ...
    private Object visitAssignExpr(Expr.Assign expr) {
    ...
    private Object visitBinaryExpr(Expr.Binary expr) {
    ...
    private Object visitCallExpr(Expr.Call expr) {
    ...
    private Object visitGetExpr(Expr.Get expr) {
    ...
    private Object visitGroupingExpr(Expr.Grouping expr) {
        return evaluate(expr.expression());
    }

    private Object visitLiteralExpr(Expr.Literal expr) {
        return expr.value();
    }

    private Object visitLogicalExpr(Expr.Logical expr) {
        Object left = evaluate(expr.left());
    ...
    private Object visitSetExpr(Expr.Set expr) {
        Object object = evaluate(expr.object());
    ...
    private Object visitSuperExpr(Expr.Super expr) {
    ...
    private Object visitThisExpr(Expr.This expr) {
        return lookUpVariable(expr.keyword(), expr);
    }

    private Object visitUnaryExpr(Expr.Unary expr) {
    ...
    private Object visitVariableExpr(Expr.Variable expr) {
