package com.craftinginterpreters.lox.ch08.tool;
...
// @formatter:on
    ...
    private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
        ...
        writer.println("package com.craftinginterpreters.ch08.lox;");
        writer.println();
        writer.println("import java.util.List;");
        writer.println();
        writer.println("import com.craftinginterpreters.ch04.lox.Token;");
        writer.println();
