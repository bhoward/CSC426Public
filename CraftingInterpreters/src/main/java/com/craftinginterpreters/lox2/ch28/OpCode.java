...
public class OpCode {
    ...
    public static final byte OP_INVOKE = 28;
    public static final byte OP_CLOSURE = 29;
    public static final byte OP_CLOSE_UPVALUE = 30;
    public static final byte OP_RETURN = 31;
    public static final byte OP_CLASS = 32;
    public static final byte OP_METHOD = 33;
}
