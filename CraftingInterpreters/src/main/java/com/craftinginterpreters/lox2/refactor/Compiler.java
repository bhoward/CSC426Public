...
public class Compiler {
    ...
    public void emitByte(OpCode opcode) {
        emitByte((byte) opcode.ordinal());
    }
    ...
    public void emitBytes(OpCode opcode, byte b) {
        emitByte(opcode);
        emitByte(b);
    }

    public void emitBytes(OpCode opcode1, OpCode opcode2) {
        emitByte(opcode1);
        emitByte(opcode2);
    }
    ...
    public void patchJump(int offset) {
        ...
        currentChunk().modify(offset, (byte) (jump >> 8));
        currentChunk().modify(offset + 1, (byte) jump);
    }
